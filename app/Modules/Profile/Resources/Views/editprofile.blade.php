...
<div class="flex-item updates-block">
    ...
    <div class="box pad edit-profile">
        <form action="http://localhost/projects/test-t/public/update-profile" method="POST">
            ...
            <div class="accordion-group">
                <div class="accordion">
                    ...
                    <div class="accordion-content" style="display: none;">
                        ...
                        <input type="text" name="org_motto" id="org_motto" value="">
                        <br>
                        <label>Choose Motto</label>
                        {!! Form::select('', $data['mottos'], $data['userprofiles']->motto, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Relationship History</label>
                        {!! Form::select('', $data['relationhistory'], $data['userprofiles']->relationhist, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Education</label>
                        {!! Form::select('', $data['education'], $data['userprofiles']->education, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Profession</label>
                        {!! Form::select('', $data['profession'], $data['userprofiles']->profession, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Body Type</label>
                        {!! Form::select('', $data['bodytype'], $data['userprofiles']->bodytype, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Zodiac</label>
                        {!! Form::select('', $data['zodiac'], $data['userprofiles']->zodiac, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Disability</label>
                        {!! Form::select('', ['y'=>'Yes','n'=>'No'], $data['userprofiles']->disability, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Fluency</label>
                        {!! Form::select('', $data['languages'], $data['userprofiles']->fluency, ['class' => 'dropdown']) !!}
                        <br>
                ...
                <div class="accordion">
                    ...
                    <div class="accordion-content" style="display: none;">
                        ...
                        {!! Form::select('', $data['color'], $data['userprofiles']->haircolor, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Hair Appearance</label>
                        {!! Form::select('', $data['hairapp'], $data['userprofiles']->hairapp, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Eye Color</label>
                        {!! Form::select('', $data['color'], $data['userprofiles']->eyecolor, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Eye Wear</label>
                        {!! Form::select('', $data['eyewear'], $data['userprofiles']->eyewear, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Weight(kg)</label>
                        <input type="number" name="weight" value="">
                        <br>
                        <label>Ethnicity</label>
                        {!! Form::select('', ['1'=>'Yes','0'=>'No'], $data['userprofiles']->ethinicity, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Tattoo</label>
                        {!! Form::select('', ['1'=>'Yes','0'=>'No'], $data['userprofiles']->tatoo, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Overall Appearance</label>
                        {!! Form::select('', $data['appearance'], $data['userprofiles']->appearance, ['class' => 'dropdown']) !!}
                    </div>
                </div>
                <div class="accordion">
                    ...
                    <div class="accordion-content" style="display: none;">
                        <label>Smoke</label>
                        {!! Form::select('', $data['smoketype'], $data['userprofiles']->smoke, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Drink</label>
                        {!! Form::select('', $data['drinktype'], $data['userprofiles']->drink, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Pet Lover</label>
                        {!! Form::select('', $data['pets'], $data['userprofiles']->pets, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Marital Status</label>
                        {!! Form::select('', $data['marital'], $data['userprofiles']->marital, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Countries Visited</label>
                        {!! Form::select('', $data['countries'], $data['userprofiles']->countries_visit, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Children</label>
                        {!! Form::select('', [1,2,3,4,5,6,7,8,9], $data['userprofiles']->children, ['class' => 'dropdown']) !!}
                        <hr>
                        <label>Relationship Looking For</label>
                        {!! Form::select('', $data['relationfor'], $data['userprofiles']->relationlooking, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Their Ethnicity</label>
                        {!! Form::select('', ['1'=>'Yes','0'=>'No'], $data['userprofiles']->relethinicity, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Their Tattoo</label>
                        {!! Form::select('', ['1'=>'Yes','0'=>'No'], $data['userprofiles']->reltatoo, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Their Appearance</label>
                        {!! Form::select('', $data['appearance'], $data['userprofiles']->relappearance, ['class' => 'dropdown']) !!}
                        <br>
                        <label>Their marital status</label>
                        {!! Form::select('', $data['marital'], $data['userprofiles']->relmarital, ['class' => 'dropdown']) !!}
                    </div>
                </div>
            </div>
            <input type="hidden" name="_token" value="GTihNXd1ib8QDq05z0cEHRf2PgMcl1zDlAnboAS1">
